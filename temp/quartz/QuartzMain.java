 ...
 * <p>Description: 调度器入口类，自动扫描所有{@link com.cn.chnskin.msg.quartz.ICronJob}对象</p>
...
public class QuartzMain {
	...
	private CronTrigger createTrigger(Entry<String, ICronJob> e) {
		CronScheduleBuilder cron = CronScheduleBuilder.cronSchedule(e
				.getValue().getCronExpression());
		TriggerBuilder<Trigger> triggerBuilder = TriggerBuilder.newTrigger()
				.withIdentity(e.getKey());
