...
import com.cn.jee.common.security.Digests;
import com.cn.jee.common.security.shiro.session.SessionDAO;
import com.cn.jee.common.service.BaseService;
import com.cn.jee.common.service.ServiceException;
import com.cn.jee.common.utils.CacheUtils;
import com.cn.jee.common.utils.Encodes;
import com.cn.jee.common.utils.StringUtils;
import com.cn.jee.common.web.Servlets;
...
import com.cn.jee.modules.sys.utils.LogUtils;
...
//			saveActivitiGroup(role);
		...
		// 更新角色与菜单关联
		roleDao.deleteRoleRecord(role);
		if (role.getRecordList().size() > 0) {
			roleDao.insertRoleRecord(role);
		}
